...
function insert_reward($dbconn,$cus_id,$point){
    $result = pg_insert($dbconn,'dcup_reward_tbl',array('id' => '','customer_id' => $cus_id,'point_count' => $point,'valid' => true, 'reward_start_date' => '2019-12-12')) or die('Query failed: ' . pg_last_error());
