...
function insert_reward($dbconn,$cus_id,$point){
    $result = pg_insert($dbconn,'dcup_reward_tbl',array('id' => '','customer_id' => $cus_id,'point_count' => 1,'valid' => true, 'reward_start_date' => 'current_timestamp')) or die('Query failed: ' . pg_last_error());
